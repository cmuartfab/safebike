...
const string data_file_name = ".csv";
...
public:
  ...
  void setup() {
    ...
    // optional: open data recording file
    if(!m_data_file_path.empty()) {
      string data_file_full_path = m_data_file_path + data_file_name;
  ...
  void print_detection(AprilTags::TagDetection& detection) const {
    ...
    //      << ", roll=" << roll
    //      << endl;
    // printf("distance=%lfm, x=%lf, y=%lf, z=%lf, yaw=%lf, pitch=%lf, roll=%lf\n",
    //        translation.norm(),
    //        translation(0),
    //        translation(1),
    //        translation(2),
    ...
    //        pitch,
    //        roll);
    fprintf(m_data_file, "%lf, %lf, %lf, %lf, %lf, %lf, %lf\n",
           translation.norm(),
           translation(0),
           translation(1),
           translation(2),
